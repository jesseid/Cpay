...
export type Theme = typeof CpayDefaultTheme;

export const CpayDarkTheme: Theme = {
  ...DarkTheme,
  barStyle: 'light-content',
  colors: {
    ...CpayDefaultTheme.colors,
    ...DarkTheme.colors,
    customHeader: '#000000',
...
export class CpayCurrentTheme {
  static colors: Theme['colors'];

  static updateColorScheme(): void {
    const isColorSchemeDark = Appearance.getColorScheme() === 'dark';
    CpayCurrentTheme.colors = isColorSchemeDark ? CpayDarkTheme.colors : CpayDefaultTheme.colors;
  }
}

CpayCurrentTheme.updateColorScheme();