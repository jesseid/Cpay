...
export const PINNED_PAGE_KEY = "chainmeta_pinned_page"
        ...
        query getNotes($characterId: Int, $limit: Int, $utcString: DateTime) {
          notes(
            where: {
              ...
              metadata: { content: { path: "sources", array_contains: "chainmeta" } }
            }
            take: $limit
          ) {
            createdAt
