  ...
  return (
    <button
      className={cn(
        ...
        (!show || appearTransition) && "translate-x-[60px] chainmeta-fab-inactive",
        !mounted && "hidden",
        className,
      )}
...
export const FABContainer = (props: {
  ...
  return (
    <div
      className={cn(
        "z-[9] right-4 bottom-[calc(1rem+env(safe-area-inset-bottom))] fixed text-lg flex flex-col chainmeta-fab",
      )}
    >
